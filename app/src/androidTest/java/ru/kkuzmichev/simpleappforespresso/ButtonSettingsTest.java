...
public class ButtonSettingsTest {
...
//            new IntentsTestRule(MainActivity.class);
    ...
    @Test
    public void mainActivityButtonSettingsTest() throws InterruptedException {
        ...
        ViewInteraction materialTextView = onView(
                allOf(withId(androidx.core.R.id.title), withText("Settings"),
                        childAtPosition(
                                childAtPosition(
...
//        Thread.sleep(15000);
        ...
        intended(hasData("https://www.google.com/"));
